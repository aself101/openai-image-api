...
Entries from 1.1.0 onward are generated by semantic-release from conventional
commits (Features / Bug Fixes / BREAKING CHANGES sections); the 1.0.0 entry
below was hand-written in [Keep a Changelog](https://keepachangelog.com/en/1.0.0/)
form. The project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
