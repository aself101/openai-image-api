 ...
 */
export type ImageModelFamily = 'gpt-image-2.5-sunburst' | 'gpt-image-2.5-flare' | 'gpt-image-2' | 'gpt-image-1.5' | 'gpt-image-1' | 'gpt-image-1-mini';
/** Dated model snapshots accepted by the API. */
export type ImageModelSnapshot = 'gpt-image-2.5-sunburst-2026-09-08' | 'gpt-image-2.5-flare-2026-09-08' | 'gpt-image-2-2026-04-21';
